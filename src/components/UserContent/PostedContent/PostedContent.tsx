...
const PostedContent = () => {
  return (
    <Box style={{ width: '100%', height: '100%' }} component="div" className={styles.postedContent}>
      <Table rows={postedContentRows} columns={postedContentColumns} customClass={styles.postedContent__table}/>
    </Box>
  );
};
